#ExternalHelp $PSScriptRoot\Get-SharePointView-help.xml
function Get-SharePointView {
    ...
    if ($View) { $params.Identity = $View }
    Get-PnPView @params
}
# SIG # Begin signature block
# MIIFYQYJKoZIhvcNAQcCoIIFUjCCBU4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUTFzr/574fJcd5DsQGwFGOL+b
# gCegggMAMIIC/DCCAeSgAwIBAgIQFnL4oVNG56NIRjNfzwNXejANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUIE8ytJj18n1xVw8tfAXuvB03
# TR4wDQYJKoZIhvcNAQEBBQAEggEAWZAtmkhqAk2SCyzZpfE4U4vwNNvy4J/sFIuz
# 2aQMa7R7dIezQww9IiOsNzkRAooAJeVDavn4ETdDY6IKo6cYsSSuIL4vU2v4c/Is
# ZWSTHO0z5Y3kxn+KdxVM4pfVahm7maps05aEpiS+/C7dUskE1hL3SVylVkOMN5fg
# CfV+sD7OLG4tsJ7NOiqlShd5JbuTiipC2aD+iOfuTXqM9zQIYT4DB943kAb0o0z6
# bTprNHq4ycYtO7/0EWC7LAzBOYN/PV33mTTPkNxPC/+Bh1K3GKfGVM4KXfcPLO85
# hb4Y77BH5jmiDS4eQtzJ/7sTkXGI/vUVflcoZK0acoS3hyDehw==
